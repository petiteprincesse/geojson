...
GP.map = (function () {
  /* Ключ Яндекс Tiles API. Получить: https://yandex.ru/maps-api/console,
     продукт «Tiles API». Пока строка пустая, «Схема Яндекс» видна
     в списке подложек, но неактивна; остальные подложки ключа не требуют.
